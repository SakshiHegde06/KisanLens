...
# Tabular crop-recommendation model (N/P/K + weather + pH -> best crop).
# Unlike the two CNNs above, class names here live inside the bundled
# joblib dict as a fitted LabelEncoder, not a raw list - same "don't
# hardcode labels separately from the trained artifact" principle.
CROP_MODEL_PATH = os.path.join(WEIGHTS_DIR, "crop_recommender.joblib")
